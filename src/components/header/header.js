...
function Header() {
  ...
  <div className="app__header">
    <div className="app__headerWrapper">
      <img className="app__logo__img" src=" https://www.instagram.com/static/images/web/mobile_nav_type_logo.png/735145cfe0a4.png" alt="Instagram original logo"/>
      <div className="barra_de_pesquisa">
          <svg className="lupa" aria-label="Pesquisar" color="#8e8e8e" fill="#8e8e8e" height="16" role="img" viewBox="0 0 24 24" width="16"><path d="M19 10.5A8.5 8.5 0 1110.5 2a8.5 8.5 0 018.5 8.5z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="16.511" x2="22" y1="16.511" y2="22"></line></svg>
          <input className="barra_pesquisa" type="search" id="pesquisa" name="pesquisa" placeholder="Pesquisa" required/>
      </div>
      <div className="app__headerButtons">
        ...
        <img className="minifotinha"src="https://i.pinimg.com/564x/b6/24/14/b62414249ec4c2fc84059656c28ce32b.jpg"></img>
      </div>  
    </div>
  </div>
);}
